...
def clean_fake_main_tweet_id(conf):    
    in_file_name = 'tweets_unfiltered_fake_main.txt'
    out_file_name = 'tweets_filtered_fake_main.txt'    
        ...
        for line in tqdm(file.readlines()):
            ...
            try:
                ...
                for s in tweet["data"]:
                    ...
                    tweets_out['article_id'].append(article_id) 
